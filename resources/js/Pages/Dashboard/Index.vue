<template>
  <div>
    ...
    <p class="mb-12 leading-normal">Hey there! Welcome to Ping CRM, a demo app designed to help illustrate how <a class="text-indigo-500 underline hover:text-orange-600" href="https://github.com/inertiajs">Inertia.js</a> works with <a class="text-indigo-500 underline hover:text-orange-600" href="https://www.yiiframework.com">Yii 2</a>.</p>
    <div>
